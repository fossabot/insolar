...
func (r *ContractConstructorHolder) AsChild(objRef core.RecordRef) (*Stage, error) {
	ref, err := proxyctx.Current.SaveAsChild(objRef, *PrototypeReference, r.constructorName, r.argsSerialized)
	if err != nil {
		return nil, err
	}
	return &Stage{Reference: ref}, nil
}

// AsDelegate saves object as delegate
func (r *ContractConstructorHolder) AsDelegate(objRef core.RecordRef) (*Stage, error) {
...
func GetObject(ref core.RecordRef) (r *Stage) {
	return &Stage{Reference: ref}
}
...
func GetImplementationFrom(object core.RecordRef) (*Stage, error) {
...
// New is constructor
func New(name string, participant participant.Participant, docsPermissions [][]DocPermission, response response.Response, expirationDate string) *ContractConstructorHolder {
...
func (r *Stage) GetReference() core.RecordRef {
	return r.Reference
}

// GetPrototype returns reference to the code
func (r *Stage) GetPrototype() (core.RecordRef, error) {
...
func (r *Stage) GetCode() (core.RecordRef, error) {
	if r.Code.IsEmpty() {
		ret := [2]interface{}{}
		var ret0 core.RecordRef
		ret[0] = &ret0
